...
class __TwigTemplate_281888364495c20cf9308272f2fda8d7801fc87d8b0ae7ea15055b4da18ae1d0 extends Twig_Template
{
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["script"]) {
                ...
                if ($this->getAttribute($context["script"], "location", array())) {
                    // line 15
                    echo "            ";
                    $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "document", array()), "addScript", array(0 => twig_array_merge((($this->getAttribute($context["script"], "extra", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["script"], "extra", array()), array())) : (array())), array("src" => $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->urlFunc($this->getAttribute($context["script"], "location", array())))), 1 => $this->getAttribute($context["script"], "priority", array()), 2 => ((($this->getAttribute($context["script"], "in_footer", array()) == true)) ? ("footer") : ("head"))), "method");
                    // line 16
                    echo "        ";
                }
                // line 17
...
{% if (particle.enabled) %}
    ...
    {% endfor %}
{% endif %}
{% endspaceless %}", "@particles/assets.html.twig", "/var/www/html/grav/user/plugins/gantry5/engines/nucleus/particles/assets.html.twig");
    }
}
