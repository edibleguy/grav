...
class __TwigTemplate_aa380f773384827150b8fc836cca469bb324fe76a7b70213112c8431e35e5141 extends Twig_Template
{
    ...
    public function block_options($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["key"] => $context["text"]) {
            ...
            // line 22
            echo "                        ";
            if ($this->env->getExtension('Gantry\Component\Twig\TwigExtension')->is_selectedFunc($context["key"], (isset($context["value"]) ? $context["value"] : null))) {
            ...
            if ($this->getAttribute($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "options", array(), "any", false, true), "label", array(), "any", true, true)) {
                echo "label=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "options", array()), "label", array()), "html", null, true);
                echo "\"";
            }
            // line 27
            echo "                        >";
    ...
    {
        return new Twig_Source("", "forms/fields/select/select.html.twig", "/var/www/html/grav/user/plugins/gantry5/admin/templates/forms/fields/select/select.html.twig");
    }
}
