...
class __TwigTemplate_6cde21a627ae7fa7ca990bca5746ad81eee90f8d6882a9138264454b33acfda7 extends Twig_Template
{
...
<div class=\"g-panes\">
    ...
    <div class=\"g-pane clearfix\" role=\"tabpanel\" id=\"g-switcher-outlines\" aria-labelledby=\"g-switcher-outlines-tab\" aria-expanded=\"false\">
        ";
        // line 44
        $context["user_conf"] = $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "outlines", array()), "copy", array()), "user", array());
        // line 45
        echo "        ";
        ...
        echo "\"
                ...
                data-switch=\"";
        // line 64
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", array(0 => (("configurations/" . (isset($context["configuration"]) ? $context["configuration"] : null)) . "/layout/switch/default")), "method"), "html", null, true);
        echo "\"
        ...
        foreach ($context['_seq'] as $context["key"] => $context["current"]) {
            if (($context["key"] != (isset($context["configuration"]) ? $context["configuration"] : null))) {
                // line 70
                echo "                ";
                $context["label"] = twig_title_string_filter($this->env, trim(twig_replace_filter($context["current"], "_", " ")));
                // line 71
                echo "                <li tabindex=\"0\"
                    aria-label=\"";
                // line 72
                echo twig_escape_filter($this->env, $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_X_OUTLINE", (isset($context["label"]) ? $context["label"] : null)), "html", null, true);
                echo "\"
                    role=\"button\"
                    data-switch=\"";
                // line 74
        ...
        if ($this->getAttribute((isset($context["system_conf"]) ? $context["system_conf"] : null), "count", array())) {
            ...
            foreach ($context['_seq'] as $context["key"] => $context["current"]) {
                // line 86
                echo "                    ";
                $context["label"] = twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, trim(twig_replace_filter($context["current"], "_", " "))));
                // line 87
                echo "                    <li tabindex=\"0\"
                        aria-label=\"";
                // line 88
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/layouts/switcher.html.twig", "/var/www/html/grav/user/plugins/gantry5/admin/templates/layouts/switcher.html.twig");
    }
}
